...
An `ImageRepository` resource can resolve the source from the contents of an image in an image registry enables app developers to create and update workloads from local source code or a code repository.
