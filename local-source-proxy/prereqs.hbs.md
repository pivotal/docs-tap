...
- Either IaaS specific trust for k8s service accounts to access the registry, or secret with
...
Using AWS
: If you're using Elastic Container Registry as your registry, you need to create the container
  ...
  2. To create the repository, run:
