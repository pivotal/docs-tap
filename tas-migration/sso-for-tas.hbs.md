...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Service Plan](https://docs.vmware.com/en/Single-Sign-On-for-VMware-Tanzu-Application-Service/1.14/sso/GUID-manage-service-plans.html)                | `AuthServer` and `ClusterWorkloadRegistrationClass`                                                                                                                            | In TAS' UAA, this is an "Identity Zone". [AuthServer docs](../app-sso/how-to-guides/service-operators/curate-service-offering.hbs.md). |
...
| [External Identity Provider](https://docs.vmware.com/en/Single-Sign-On-for-VMware-Tanzu-Application-Service/1.14/sso/GUID-configure-external-id.html) | `AuthServer.spec.identityProviders`                                                                                                                                            | [spec.identityProviders docs](../app-sso/how-to-guides/service-operators/identity-providers.hbs.md)                                                                                                                                                                                                      |
...
see [official documentation](../app-sso/how-to-guides/app-operators/secure-spring-boot-workload.hbs.md).
...
the [official documentation](../app-sso/how-to-guides/app-operators/secure-workload.hbs.md)
