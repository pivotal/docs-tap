...
For more information about profiles, see [Installing the Tanzu Application Platform Package and Profiles](https://docs-staging.vmware.com/en/draft/Tanzu-Application-Platform/1.2/tap/GUID-install.html).
