...
## <a id="generate-yaml-files-using-initializer"></a> Generate YAML files using Tanzu Application Platform Initializer
...
You can follow these steps to generate YAML files using Tanzu Application Platform Initializer:
...
- Verify the parameters to use the initializer and click **Generate Accelerator**.
  ![Screenshot of confirming the parameters for the initializer](images/runtime-resources-initializer-confirmation.png)
- After the process is complete, you must download the package (a zip file that includes the generated files), uncompress it and follow the instructions in the `INSTRUCTIONS.md` file.
