...
- Check the parameters to use the initializer and click **Generate Accelerator**.
  ![Screenshot of confirming the parameters for the initializer](images/runtime-resources-initializer-confirmation.png)
- Once the process is complete, you will need to download the package (a zip file) with generated files, uncompress it and follow instructions in the `INSTRUCTIONS.md` file.
