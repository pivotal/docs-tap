...
From Tanzu Application Platform v1.5, the git repository creation can be disabled by setting the
...
An example to disable the feature would be as:
...
> NOTE: In tanzu application platform v1.4 the Application Accelerator extension for VS Code used a deprecated property
> to disable the git repository feature, to check that property go to this [page](./application-accelerator-git-repo.hbs.md#deactiv-git-repo-creatio)
