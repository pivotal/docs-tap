...
To control the access to Kubernetes runtime resources on Tanzu Developer Portal based on users' roles
and permissions for each of visible remote clusters, VMware recommends two role types:
