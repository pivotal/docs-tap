...
- `KNOWN_HOSTS` are the [SSH client stored host keys](https://www.ssh.com/academy/ssh/host-key#known-host-keys) as generated by [ssh-keyscan](https://man.openbsd.org/ssh-keyscan)
    - e.g. `ssh-keyscan github.com` will produce
        ```bash
