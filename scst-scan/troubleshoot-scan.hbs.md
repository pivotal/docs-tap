...
For SCST - Scan `v1.5.0` or later, you will see scanner pods restart:
```
Pods
   NAME                                  READY   STATUS      RESTARTS   AGE
   my-scan-45smk-pod                     0/9     Completed   1          14m
```
One restart in scanner pods is expected with successful scans. To support TSM integration, jobs were replaced with TaskRuns. This restart is an artifact of how tekton cleans up sidecar containers by patching the container spec.