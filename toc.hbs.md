...
- [Component documentation](components.hbs.md)
    ...
    - [Service Registry](service-registry/overview.hbs.md)
      ...
      - [Get Started with Service Registry](service-registry/getting-started/index.hbs.md)
          - [Configure Eureka servers](service-registry/getting-started/configuring-eureka-servers.hbs.md)
          - [Configure workloads](service-registry/getting-started/configuring-workloads.hbs.md)
