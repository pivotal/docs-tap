...
- [Security and compliance overview](security-and-compliance/about.hbs.md)
  - [TLS and certificates in Tanzu Application Platform overview](security-and-compliance/tls-and-certificates/about.hbs.md)
    ...
    - [Use External Secrets Operator in Tanzu Application Platform (beta)](external-secrets/about-external-secrets-operator.hbs.md)
          - [About External Secrets Operator](external-secrets/about-external-secrets-operator.hbs.md)
          ...
          - [external-secrets CLI reference](external-secrets/reference/external-secrets.hbs.md)
      ...
      - [CLI plug-ins](cli-plugins/tanzu-cli-plugin.hbs.md)
          ...
          - [Insight](cli-plugins/insight/cli-overview.hbs.md)
                ...
                - [Command reference](cli-plugins/insight/cli-docs/tanzu_insight.hbs.md)
                    ...
                    - [tanzu insight package vulnerabilities](cli-plugins/insight/cli-docs/tanzu_insight_report.hbs.md)
                    - [tanzu insight package vulnerabilities](cli-plugins/insight/cli-docs/tanzu_insight_report_get.hbs.md)
                    - [tanzu insight package vulnerabilities](cli-plugins/insight/cli-docs/tanzu_insight_report_list.hbs.md)
                    ...
                    - [tanzu insight triage list](cli-plugins/insight/cli-docs/tanzu_insight_triage_rebase.hbs.md)
