...
- [Component documentation](components.hbs.md)
    ...
    - [Application Single Sign-On (AppSSO)](app-sso/about.hbs.md)
        ...
        - [Tutorials](app-sso/tutorials/index.hbs.md)
            - [AppSSO for platform operators](app-sso/tutorials/platform-operators/index.hbs.md)
                ...
                - [AppSSO for OpenShift clusters](app-sso/tutorials/platform-operators/openshift.hbs.md)
            ...
            - [AppSSO for app operators](app-sso/tutorials/app-operators/index.hbs.md)
                - [AppSSO for app operators overview](app-sso/tutorials/app-operators/index.hbs.md)
                - [Configure AppSSO for workloads](app-sso/tutorials/app-operators/workloads-and-appsso.hbs.md)
                - [Secure a Spring Boot workload](app-sso/tutorials/app-operators/secure-spring-boot-workload.hbs.md)
                - [Secure a single-page app workload](app-sso/tutorials/app-operators/secure-spa-workload.hbs.md)
        - [Reference](app-sso/reference/index.hbs.md)
            ...
            - [Troubleshoot](app-sso/reference/troubleshoot.hbs.md)
    ...
    - [Crossplane](crossplane/about.hbs.md)
        ...
        - [How-to guides](crossplane/how-to-guides/index.hbs.md)
            - [Use a pre-existing or out-of-band installation of Crossplane with Tanzu Application Platform](crossplane/how-to-guides/use-pre-existing-crossplane-tap.hbs.md)
            - [Delete all Crossplane resources upon deletion of Tanzu Application Platform](crossplane/how-to-guides/delete-resources.hbs.md)
