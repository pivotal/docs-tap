      ...
      - [CLI plug-ins](cli-plugins/tanzu-cli-plugin.hbs.md)
          ...
          - [Apps](cli-plugins/apps/overview.hbs.md)
                ...
                - [How-to-Guides](cli-plugins/apps/how-to-guides/how-to-guides.hbs.md)
                    - [Create a workload from a private Git repository](cli-plugins/apps/how-to-guides/how-to-guide-1.hbs.md#create-a-workload-from-a-private-git-repository)
                    - [Bind a service to a workload](cli-plugins/apps/how-to-guides/how-to-guide-1.hbs.md#bind-a-service-to-a-workload)
