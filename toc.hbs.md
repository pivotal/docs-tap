...
- [Get started](getting-started.hbs.md)
  ...
  - [How-to guides for developers](getting-started/generate-first-app.hbs.md)
      ...
      - [Create new application accelerator](getting-started/create-app-accelerator.hbs.md)
...
- [Component documentation](components.hbs.md)
    ...
    - [Application Live View](app-live-view/about-app-live-view.hbs.md)
        ...
        - [Install Application Live View Connector as a service](app-live-view/install-connector-as-a-service.hbs.md)
