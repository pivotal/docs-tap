      ...
      - [CLI plug-ins](cli-plugins/tanzu-cli-plugin.hbs.md)
          ...
          - [Apps](cli-plugins/apps/overview.hbs.md)
                ...
                - [Getting started](cli-plugins/apps/getting-started/getting-started.hbs.md)
                    - [Apps CLI Plug-in installation](cli-plugins/apps/getting-started/installation.hbs.md)
                    - [Apps CLI Plug-in configuration](cli-plugins/apps/getting-started/configuration.hbs.md)
                ...
                - [Troubleshooting in Apps CLI Plug-in](cli-plugins/apps/troubleshooting/troubleshooting.hbs.md)
                    - [Troubleshooting workloads](cli-plugins/apps/troubleshooting/troubleshooting-workload.hbs.md)
                    - [Troubleshooting LSP integration](cli-plugins/apps/troubleshooting/troubleshooting-workload.hbs.md#local-source-proxy-integration)
                - [Reference](cli-plugins/apps/reference/reference.hbs.md)
                    ...
                    - [Workload Create/Apply Flag Reference](cli-plugins/apps/reference/workload-create-apply.hbs.md)
