...
![Screenshot of Tanzu Application Platform GUI displaying the error message about loading data from the metadata store message.](docs-tap/images/scc-error-loading-metadata-store.png)
