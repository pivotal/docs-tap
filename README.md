...
| Branch | Usage |
|--------|-------|
| main | Development branch for pre-release v1.2 docs staged at https://docs-staging.vmware.com/en/VMware-Tanzu-Application-Platform/1.2/tap/GUID-overview.html |
