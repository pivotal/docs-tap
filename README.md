...
| Branch | Usage |
|--------|-------|
| main | Development branch for pre-release beta-4 docs staged at https://docs-staging.vmware.com/en/VMware-Tanzu-Application-Platform/0.4/tap-0-4/GUID-overview.html |
