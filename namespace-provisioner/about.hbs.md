...
parameters which are used as `data.values` for customizing platform-operator defined resources.
Manage the ConfigMap directly with [GitOps](#nsp-using-gitops), or the [Namespace Provisioner Controller](#nsp-controller) described below.
