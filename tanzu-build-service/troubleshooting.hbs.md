...
specified in `shared.image_registry.project_path`. This will cause all the existing workloads' image
...
workload), the workload will then recreate it with valid values.
