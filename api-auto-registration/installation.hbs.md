...
>**Note:** Use the instructions in this topic if you do not want to use the iterate, run, or full profile to install packages.
...
3. (Optional) Create `api-auto-registration-values.yaml`:
