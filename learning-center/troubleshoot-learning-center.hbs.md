...
Due to a security improvement in Learning Center, session.objects, environment.objects and session.patches are not working properly in TAP 1.2.2 and 1.3.0. VMware resolved this issue by Learning Center `v0.2.4` in TAP 1.3.2.