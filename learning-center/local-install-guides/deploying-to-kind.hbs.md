...
For information about installing Contour, which comes with Tanzu Application Platform, see [Install cert-manager, Contour](../../cert-mgr-contour-fcd/install-cert-mgr.hbs.md#install-contour).
