...
* Download and install the [Tanzu CLI](../install-tanzu-cli.html#-install-or-update-the-tanzu-cli-and-plug-ins)
* Download and install the [Tanzu CLI RBAC plug-in](binding.html)
* Install [Pinniped supervisor and concierge](pinniped-install-guide-lets-encrypt.hbs.md) on the cluster without
setting up the [OIDCIdentityProvider and secret](pinniped-install-guide-lets-encrypt.hbs.md#create-pinniped-supervisor-configuration) yet.
