...
- [Component documentation](components.md)
    ...
    - [Tanzu Developer Tools for Visual Studio Code](vscode-extension/about.md)
      - [Overview of Tanzu Dev Tools for VS Code](vscode-extension/about.md)
      - [Installing Tanzu Dev Tools for VS Code](vscode-extension/install.md)
      - [Getting Started with Tanzu Dev Tools for VS Code](vscode-extension/getting-started.md)
      - [Using Tanzu Dev Tools for VS Code](vscode-extension/using-the-extension.md)
      ...
      - [Troubleshooting Tanzu Dev Tools for VS Code](vscode-extension/troubleshooting.md)
    - [Tanzu Developer Tools for IntelliJ](intellij-extension/about.md)
      - [Overview of Tanzu Dev Tools for IntelliJ](intellij-extension/about.md)
      - [Installing Tanzu Dev Tools for IntelliJ](intellij-extension/install.md)
      - [Getting Started with Tanzu Dev Tools for IntelliJ](intellij-extension/getting-started.md)
      - [Using Tanzu Dev Tools for IntelliJ](intellij-extension/using-the-extension.md)
      - [Glossary of Terms](intellij-extension/glossary.md)
      - [Troubleshooting Tanzu Dev Tools for IntelliJ](intellij-extension/troubleshooting.md)
      - [Known Issues with Tanzu Dev Tools for IntelliJ](intellij-extension/known-issues.md)
