...
- [Installation](install-intro.md)
  ...
  - [Online install](online-install-intro.hbs.md)
      ...
      - [Install packages and profiles](install.md)
      - [View package config settings](view-package-config.md)
      - [Install individual packages](install-components.md)
  ...
  - [Air-gapped install](offline-install-intro.hbs.md)
      ...
      - [Install packages and profiles](install-air-gap.md)
...
- [Component documentation](components.md)
    ...
    - [Authentication and authorization](authn-authz/overview.md)
        - [Authentication and authorization overview](authn-authz/overview.md)
        - [Set up authentication](authn-authz/integrating-identity.md)
            - [Overview](authn-authz/integrating-identity.md)
            - [Install Pinniped](authn-authz/pinniped-install-guide.md)
            - [Integrate Azure Active Directory](authn-authz/azure-ad.md)
        ...
        - [Log in using Pinniped](authn-authz/pinniped-login.md)
    ...
    - [Spring Boot conventions](spring-boot-conventions/about.md)
      ...
      - [Configure Spring Boot actuators](spring-boot-conventions/configuring-spring-boot-actuators.md)
    ...
    - [Supply Chain Choreographer](scc/about.md)
      - [Supply Chain Choreographer overview](scc/about.md)
      ...
      - [Use an existing image](scc/pre-built-image.md)
      - [Git authentication](scc/git-auth.md)
      - [GitOps vs. RegistryOps](scc/gitops-vs-regops.md)
      - [Author Supply Chains](scc/authoring-supply-chains.md)
    - [Supply Chain Security Tools for Tanzu – Scan](scst-scan/overview.md)
        - [Supply Chain Security Tools for Tanzu – Scan overview](scst-scan/overview.md)
        - [Install Scan Controller and default scanner](scst-scan/install-scst-scan.md)
        - [Upgrade Supply Chain Security Tools - Scan](scst-scan/upgrading.md)
    ...
    - [Tanzu Developer Tools for Visual Studio Code](vscode-extension/about.md)
      ...
      - [Get Started](vscode-extension/getting-started.md)
    ...
    - [Tanzu Developer Tools for IntelliJ](intellij-extension/about.md)
      ...
      - [Get Started](intellij-extension/getting-started.md)
    ...
    - [Tanzu Application Platform GUI](tap-gui/about.md)
      ...
      - [Configure TLS](tap-gui/tls/overview.md)
         ...
         - [Configure by using an existing certificate](tap-gui/tls/enable-tls-existing-cert.md)
         - [Configure by using a self-signed certificate](tap-gui/tls/enable-self-signed-cert.md)
         - [Configure by using cert-manager and external ClusterIssuer](tap-gui/tls/cert-mngr-ext-clusterissuer.md)
    ...
    - [Tanzu Build Service](tanzu-build-service/tbs-about.md)
      ...
      - [Work with Tanzu Buildpacks](tanzu-build-service/tbs-buildpacks.md)
      ...
      - [Create a GitHub Action](tanzu-build-service/build-image-action.md)
