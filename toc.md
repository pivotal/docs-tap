...
- [Tanzu Application Platform v1.4](overview.hbs.md)
...
- [Installation](install-intro.hbs.md)
  ...
  - [Accepting EULAs and installing Tanzu CLI](install-tanzu-cli.hbs.md)
  - [Online installation](install.hbs.md)
  ...
  - [Air-gapped installation](install-air-gap.hbs.md)
...
- [Getting started](getting-started.hbs.md)
  ...
  - [Learn more](getting-started/concepts.hbs.md)
      ...
      - [Vulnerability scanning and metadata storage](getting-started/about-vulnerability-scan-store.hbs.md)
      - [About consuming services](getting-started/about-consuming-services.hbs.md)
- [Troubleshooting](troubleshooting.hbs.md)
  - [Troubleshooting overview](troubleshooting.hbs.md)
...
- [Component documentation](components.hbs.md)
    ...
    - [Authentication and authorization](authn-authz/overview.hbs.md)
        ...
        - [Setting up authentication](authn-authz/integrating-identity.hbs.md)
            - [Overview](authn-authz/integrating-identity.hbs.md)
            - [Installing Pinniped](authn-authz/pinniped-install-guide.hbs.md)
    ...
    - [API Auto Registration](api-auto-registration/about.hbs.md)
        ...
        - [Using API Auto Registration](api-auto-registration/usage.hbs.md)
    ...
    - [Application Live View](app-live-view/about-app-live-view.hbs.md)
        ...
        - [Configuring apps](app-live-view/configuring-apps/spring-boot-enablement.hbs.md)
            - [Enabling Spring Boot apps](app-live-view/configuring-apps/spring-boot-enablement.hbs.md)
            - [Enabling Steeltoe apps](app-live-view/configuring-apps/steeltoe-enablement.hbs.md)
            ...
            - [Scaling Knative apps](app-live-view/configuring-apps/scaling-applications.hbs.md)
            - [Application Live View on OpenShift](app-live-view/configuring-apps/openshift.hbs.md)
    ...
    - [Application Single Sign-On (AppSSO)](app-sso/about.hbs.md)
        ...
        - [Getting started](app-sso/getting-started/appsso-overview.hbs.md)
            - [Getting started overview](app-sso/getting-started/appsso-overview.hbs.md)
        ...
        - [AppSSO for platform operators](app-sso/platform-operators/index.hbs.md)
            ...
            - [UpgradeAppSSO](app-sso/upgrades/index.hbs.md)
        ...
        - [AppSSO for app operators](app-sso/app-operators/index.hbs.md)
            ...
            - [Set up developer namespaces](app-sso/appendix/tap-dev-ns-setup-example.hbs.md)
        ...
        - [Troubleshooting AppSSO](app-sso/troubleshoot.hbs.md)
    ...
    - [Learning Center](learning-center/about.hbs.md)
      ...
      - [Getting started](learning-center/getting-started/about.hbs.md)
        ...
        - [Creating workshops](learning-center/workshop-content/about.hbs.md)
          - [Creating workshops overview](learning-center/workshop-content/about.hbs.md)
    ...
    - [Supply Chain Choreographer](scc/about.hbs.md)
      ...
      - [Using an existing image](scc/pre-built-image.hbs.md)
    ...
    - [Supply Chain Security Tools for Tanzu – Scan](scst-scan/overview.hbs.md)
        - [Supply Chain Security Tools for Tanzu – Scan overview](scst-scan/overview.hbs.md)
        - [Install Scan Controller and default scanner](scst-scan/install-scst-scan.hbs.md)
    ...
    - [Tanzu Developer Tools for Visual Studio Code](vscode-extension/about.hbs.md)
      ...
      - [Integrating Live Hover by using Spring Boot Tools](vscode-extension/live-hover.hbs.md)
    ...
    - [Tanzu Developer Tools for IntelliJ](intellij-extension/about.hbs.md)
      ...
      - [Getting Started](intellij-extension/getting-started.hbs.md)
    ...
    - [Tanzu Application Platform GUI](tap-gui/about.hbs.md)
      ...
      - [Configuring TLS](tap-gui/tls/overview.hbs.md)
         - [Overview of enabling TLS for Tanzu Application Platform GUI](tap-gui/tls/overview.hbs.md)
         ...
         - [Configure by using cert-manager and an external ClusterIssuer](tap-gui/tls/cert-mngr-ext-clusterissuer.hbs.md)
