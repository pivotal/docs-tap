...
- [Installing Tanzu Application Platform](install-intro.md)
  ...
  - [Installing Tanzu Application Platform online](install.md)
      ...
      - [Installing Tanzu Developer Tools for VS Code](reused-install-topics/vscode-extension-install-online.md)
  ...
  - [Installing Tanzu Application Platform on AWS Cloud](aws/aws-resources.md)
      - [Creating AWS Resources](aws/aws-resources.md)
      - [Installing Tanzu Application Platform](aws/install.md)
          - [Installing Tanzu Application Platform packages and profiles](aws/install.md)
          - [Viewing possible configuration settings for your package](aws/view-package-config.md)
      - [Installing Individual Packages](aws/install-components.md)
      - [Setting up developer namespaces to use installed packages](aws/set-up-namespaces.md)
      - [Installing Tanzu Developer Tools for VS Code](aws/vscode-extension-install.md)
...
- [Component documentation](components.md)
    ...
    - [Application Single Sign-On](app-sso/about.md)
        ...
        - [AppSSO for Platform Operators](app-sso/platform-operators/index.md)
            - [Installation](app-sso/platform-operators/installation.md)
            - [Configuration](app-sso/platform-operators/configuration.md)
            - [RBAC](app-sso/platform-operators/rbac.md)
        ...
        - [AppSSO for Service Operators](app-sso/service-operators/index.md)
            ...
            - [Readiness](app-sso/service-operators/readiness.md)
            - [Scale](app-sso/service-operators/scale.md)
            - [Audit logs](app-sso/service-operators/audit-logs.md)
            - [Troubleshooting](app-sso/service-operators/troubleshooting.md)
            - [Known limitations](app-sso/service-operators/known-limitations.md)
        - [AppSSO for App Operators](app-sso/app-operators/index.md)
            ...
            - [Grant types](app-sso/app-operators/grant-types.md)
            - [Tutorials](app-sso/app-operators/tutorials/index.md)
              - [Securing first Workload](app-sso/app-operators/tutorials/securing-first-workload.md)
            - [Troubleshooting](app-sso/app-operators/troubleshooting.md)
        - [APIs](app-sso/crds/index.md)
        ...
        - [Upgrades](app-sso/upgrades/index.md)
        - [Appendix](app-sso/appendix/index.md)
          - [TAP dev namespace setup example](app-sso/appendix/tap-dev-ns-setup-example.md)
    ...
    - [Tanzu Application Platform GUI](tap-gui/about.md)
      ...
      - [Customizing Tanzu Application Platform GUI](tap-gui/customize/customize-portal.md)
          - [Customizing the portal](tap-gui/customize/customize-portal.md)
