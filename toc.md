...
- [Installing Tanzu Application Platform](install-intro.md)
  ...
  - [Installing Tanzu Application Platform in an air-gapped environment](install-air-gap.md)
      ...
      - [Configuring custom CAs for Tanzu Application Platform GUI](non-standard-certs-offline.md)
  ...
  - [Installing Tanzu Application Platform on AWS Cloud](install-aws.md)
      ...
      - [Installing Tanzu Developer Tools for VS Code](vscode-install-aws.md)
...
- [Component documentation](components.md)
    ...
    - [API portal for VMware Tanzu](api-portal/about.md)
        - [Overview of API portal](api-portal/about.md)
    ...
    - [Application Single Sign-On](app-sso/about.md)
        ...
        - [Getting started with Application Single Sign-On](app-sso/getting-started/appsso-overview.md)
            - [Overview of getting started](app-sso/getting-started/appsso-overview.md)
            ...
            - [Deploy an application with Application Single Sign-On](app-sso/getting-started/application.md)
        - [Application Single Sign-On for Platform Operators](app-sso/platform-operators/index.md)
            - [Overview of Application Single Sign-On for Platform Operators](app-sso/platform-operators/index.md)
            - [Install Application Single Sign-On](app-sso/platform-operators/installation.md)
            - [Configure Application Single Sign-On](app-sso/platform-operators/configuration.md)
            - [RBAC for Application Single Sign-On](app-sso/platform-operators/rbac.md)
            - [Application Single Sign-On for OpenShift cluster](app-sso/platform-operators/openshift.md)
            - [Upgrade Application Single Sign-On](app-sso/upgrades/index.md)
            - [Uninstall Application Single Sign-On](app-sso/platform-operators/uninstallation.md)
        - [Application Single Sign-On for Service Operators](app-sso/service-operators/index.md)
            - [Overview of Application Single Sign-On for Service Operators](app-sso/service-operators/index.md)
        ...
        - [Troubleshooting Application Single Sign-On](app-sso/troubleshoot.md)
    ...
    - [Eventing](eventing/about.md)
      - [Overview of Eventing](eventing/about.md)
    ...
    - [Supply Chain Choreographer for Tanzu](scc/about.md)
      ...
      - [How-to guides for Supply Chain Choreographer for Tanzu](scc/scc-how-to.hbs.md)
    ...
    - [Supply Chain Security Tools for Tanzu – Scan](scst-scan/overview.md)
        ...
        - [Install Another Scanner](scst-scan/install-scanners.hbs.md)
            - [Available Scanners for Supply Chain Security Tools - Scan](scst-scan/available-scanners.hbs.md)
    ...
    - [Tanzu Application Platform GUI](tap-gui/about.md)
      ...
      - [Customizing Tanzu Application Platform GUI](tap-gui/customize/customize-portal.md)
          - [Customizing the portal and support menu](tap-gui/customize/customize-portal.md)
      ...
      - [Managing role-based access control](tap-gui/tap-gui-rbac/set-up-tap-gui-rbac.md)
          ...
          - [Viewing runtime resources on authorization-enabled clusters](tap-gui/tap-gui-rbac/view-resources-rbac.md)
    ...
    - [Tanzu Application Platform Telemetry](telemetry/overview.md)
      ...
      - [Deployment details and configurations of Tanzu Application Platform Telemetry](telemetry/deployment-details.md)
