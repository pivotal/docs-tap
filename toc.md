...
- [Component documentation](components.md)
  - [Installing individual packages](install-components.md)
    ...
    - [Application Accelerator](application-accelerator/index.md)
        ...
        - [Specifications](application-accelerator/specs/index.md)
        ...
        - [Troubleshooting](application-accelerator/troubleshooting.md)
            - [Uninstalling](application-accelerator/installation/uninstall.md)
...
- [Workload types](workloads/workload-types.md)
  - [Web workloads](workloads/web.md)
