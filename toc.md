...
- [Installation](install-intro.md)
  ...
  - [Install on AWS Cloud](aws-install-intro.hbs.md)
      ...
      - [Create AWS Resources](aws-resources.md)
      - [Install packages and profiles](install-aws.md)
      - [View package config settings](view-package-config-aws.md)
      - [Install individual packages](install-components-aws.md)
      - [Set up namespaces](set-up-namespaces-aws.md)
