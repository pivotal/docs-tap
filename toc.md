...
- [Installation](install-intro.md)
  ...
  - [Accepting EULAs and installing Tanzu CLI](install-tanzu-cli.md)
  - [Online installation](online-install-intro.hbs.md)
  ...
  - [Air-gapped installation](offline-install-intro.hbs.md)
  ...
  - [Installing on AWS Cloud](aws-install-intro.hbs.md)
      - [Installation overview](aws-install-intro.hbs.md)
  ...
  - [Installing on OpenShift clusters](install-openshift.md)
      - [Install packages and profiles](install-openshift.md)
...
- [Getting started](getting-started.md)
  ...
  - [Learn more](getting-started/concepts.md)
      ...
      - [Vulnerability scanning and metadata storage](getting-started/about-vulnerability-scan-store.md)
...
- [Component documentation](components.md)
    ...
    - [Authentication and authorization](authn-authz/overview.md)
        ...
        - [Setting up authentication](authn-authz/integrating-identity.md)
            - [Overview](authn-authz/integrating-identity.md)
            - [Installing Pinniped](authn-authz/pinniped-install-guide.md)
    ...
    - [API Auto Registration](api-auto-registration/about.md)
        ...
        - [Using API Auto Registration](api-auto-registration/usage.md)
        - [Troubleshooting](api-auto-registration/troubleshooting.md)
    ...
    - [Application Live View](app-live-view/about-app-live-view.md)
        ...
        - [Configuring apps](app-live-view/configuring-apps/spring-boot-enablement.md)
            - [Enabling Spring Boot apps](app-live-view/configuring-apps/spring-boot-enablement.md)
            - [Enabling Steeltoe apps](app-live-view/configuring-apps/steeltoe-enablement.md)
            ...
            - [Scaling Knative apps](app-live-view/configuring-apps/scaling-applications.md)
            - [Application Live View on OpenShift](app-live-view/configuring-apps/openshift.md)
    ...
    - [Application Single Sign-On (AppSSO)](app-sso/about.md)
        ...
        - [Getting started](app-sso/getting-started/appsso-overview.md)
            - [Getting started overview](app-sso/getting-started/appsso-overview.md)
        ...
        - [Troubleshooting AppSSO](app-sso/troubleshoot.md)
    ...
    - [Learning Center](learning-center/about.md)
      ...
      - [Getting started](learning-center/getting-started/about.md)
        ...
        - [Creating workshops](learning-center/workshop-content/about.md)
          - [Creating workshops overview](learning-center/workshop-content/about.md)
    ...
    - [Supply Chain Choreographer](scc/about.md)
      ...
      - [Using an existing image](scc/pre-built-image.md)
    ...
    - [Tanzu Developer Tools for IntelliJ](intellij-extension/about.md)
      ...
      - [Getting Started](intellij-extension/getting-started.md)
    ...
    - [Tanzu Application Platform GUI](tap-gui/about.md)
      ...
      - [Managing role-based access control](tap-gui/tap-gui-rbac/set-up-tap-gui-rbac.md)
      ...
      - [Tanzu Application Platform GUI plug-ins](tap-gui/plugins/about.md)
         ...
         - [Application Accelerator](tap-gui/plugins/application-accelerator.md)
             ...
             - [Install Application Accelerator](application-accelerator/install-app-acc.md)
             - [Creating an Application Accelerator Git repository](tap-gui/plugins/application-accelerator-git-repo.hbs.md)
      ...
      - [Configuring TLS](tap-gui/tls/overview.md)
         ...
         - [Configure by using cert-manager and an external ClusterIssuer](tap-gui/tls/cert-mngr-ext-clusterissuer.md)
