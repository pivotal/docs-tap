...
- [Installation](install-intro.hbs.md)
  ...
  - [Install on Azure Cloud](azure-install/azure-install-intro.hbs.md)
      - [Install overview](azure-install/azure-install-intro.hbs.md)
      - [Create Azure Resources](azure-install/azure-resources.hbs.md)
      - [Install packages and profiles](azure-install/install-azure.hbs.md)
      - [View package config settings](azure-install/view-package-config-azure.hbs.md)
      - [Install individual packages](azure-install/install-components-azure.hbs.md)
      - [Set up namespaces](azure-install/set-up-namespaces-azure.hbs.md)
      - [Install Tanzu Developer Tools for VS Code](azure-install/vscode-install-azure.hbs.md)
