...
- [Installation](install-intro.hbs.md)
  ...
  - [Install on Azure Cloud](azure-install-intro.hbs.md)
      ...
      - [Create Azure Resources](azure-resources.hbs.md)
      - [Install packages and profiles](install-azure.hbs.md)
      - [View package config settings](view-package-config-azure.hbs.md)
      - [Install individual packages](install-components-azure.hbs.md)
      - [Set up namespaces](set-up-namespaces-azure.hbs.md)
