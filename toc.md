...
- [Installation](install-intro.hbs.md)
  ...
  - [Install on Azure Cloud](azure-install/intro.hbs.md)
      - [Install overview](azure-install/intro.hbs.md)
      - [Create Azure Resources](azure-install/resources.hbs.md)
      - [Install packages and profiles](azure-install/profile.hbs.md)
      - [View package config settings](azure-install/view-package-config.hbs.md)
      - [Install individual packages](azure-install/components.hbs.md)
      - [Set up namespaces](azure-install/set-up-namespaces.hbs.md)
      - [Install Tanzu Developer Tools for VS Code](azure-install/vscode-install.hbs.md)
  ...
  - [Install with GitOps](install-gitops-intro.hbs.md)
      ...
      - [Uninstall](uninstall-gitops.hbs.md)
      - [Reference](gitops-reference-docs.hbs.md)
...
- [Component documentation](components.hbs.md)
    ...
    - [Services Toolkit](services-toolkit/about.hbs.md)
      ...
      - [Tutorials](services-toolkit/tutorials.hbs.md)
        - [Setup Dynamic Provisioning of Service Instances](services-toolkit/tutorials/setup-dynamic-provisioning.hbs.md)
        - [Working with Bitnami Services](services-toolkit/tutorials/working-with-the-bitnami-services.hbs.md)
      ...
      - [How-To Guides](services-toolkit/how-to-guides.hbs.md)
        ...
        - [Debug](services-toolkit/how-to-guides/debug.hbs.md)
      - [Explanation](services-toolkit/explanation.hbs.md)
        - [Four Levels of Service Consumption in Tanzu Application Platform](services-toolkit/explanation/four-levels-of-service-consumption.hbs.md)
        - [Class Claims vs Resource Claims](services-toolkit/explanation/class-claim-vs-resource-claim.hbs.md)
      - [Reference](services-toolkit/reference.hbs.md)
        - [API Documentation](services-toolkit/reference/api-documentation.hbs.md)
        ...
        - [Terminology and User roles](services-toolkit/reference/terminology_and_user_roles.hbs.md)
    ...
    - [Supply Chain Choreographer](scc/about.hbs.md)
      ...
      - [How-to Guides](scc/scc-how-to.hbs.md)
          ...
          - [Building container images](scc/build-container-img.hbs.md)
            ...
            - [Deploy Package and PackageInstall using FluxCD Kustomization](scc/delivery-with-flux.hbs.md)
            - [Use Blue-green deployment with Contour and PackageInstall](scc/blue-green-with-packageinstall.hbs.md)
