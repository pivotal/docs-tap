...
- [Component documentation](components.md)
    ...
    - [Tanzu Application Platform GUI](tap-gui/about.md)
      ...
      - [Managing role-based access control](tap-gui/tap-gui-rbac/overview.md)
          - [Enabling authorization on remote clusters](tap-gui/tap-gui-rbac/setup-tap-gui-rbac-only-gke.md)
          - [Enabling authorization on remote GKE clusters using Google Auth](tap-gui/tap-gui-rbac/setup-tap-gui-rbac-with-gke-auth.md)
