...
- [Component documentation](components.hbs.md)
    ...
    - [Application Single Sign-On (AppSSO)](app-sso/about.hbs.md)
        ...
        - [API reference](app-sso/api-reference/index.hbs.md)
            - [AuthServer](app-sso/api-reference/authserver.hbs.md)
            - [ClientRegistration](app-sso/api-reference/clientregistration.hbs.md)
            TODO(mbrauer)
