...
1. (Optional) Make changes to the default installation settings:
    ...
    1. Create a `cnr-values.yaml` by using the following sample as a guide:
        ...
        [Cloud Native Runtimes documentation](https://docs.vmware.com/en/Cloud-Native-Runtimes-for-VMware-Tanzu/1.1/tanzu-cloud-native-runtimes/GUID-local-dns.html#config-cluster).
        ...
        For information about how to prevent conflicts, see [Installing Cloud Native Runtimes for Tanzu with an Existing Contour Installation](https://docs.vmware.com/en/Cloud-Native-Runtimes-for-VMware-Tanzu/1.1/tanzu-cloud-native-runtimes/GUID-contour.html) in the Cloud Native Runtimes documentation.
...
see [Verify your Installation](https://docs.vmware.com/en/Cloud-Native-Runtimes-for-VMware-Tanzu/1.1/tanzu-cloud-native-runtimes/GUID-verify-installation.html)
