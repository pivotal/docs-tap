...
If an accelerator still displays in the Tanzu Developer Portal after it is deleted using the
`tanzu accelerator delete` command, complete the following steps to delete:
