...
To enable SCST - Scan to store scan results to SCST - Store, [follow the instructions](../scst-store/developer-namespace-setup.hbs.md) to export the SCST - Store CA certificate and authentication token to the developer namespace.
