...
- Supply Chain Security Tools - Policy is defaulting to TUF enabled. This can cause the package to not reconcile correctly if the default TUF mirrors are not reachable.
