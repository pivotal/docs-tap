...
Tanzu Application Platform now supports OpenShift v4.10 and Kubernetes 1.24:
...
- Upgrade fails when you attempt to upgrade from Tanzu Application Platform v1.0 or v1.1. For more information, see [Upgrade workaround](upgrading.hbs.md#upgrade-workaround).
