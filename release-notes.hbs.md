...
- [Supply Chain Security Tools - Scan 2.0](scst-scan/app-scanning-beta.hbs.md) is promoted from `alpha` to `beta`.  This promotion primaily includes capabilities to integrate the SCST-Scan 2.0 component with other components of the Tanzu Application Platform, including: 
  ...
  - [AMR Observers (Alpha)](scst-store/amr/overview.hbs.md#amr-observer) observes scan results from Supply Chain Security Tools - Scan 2.0 and archives them to the [AMR (beta)](scst-store/amr/architecture.hbs.md) for long term storage and reporting, as well as use by other Tanzu Application Platform Components
  ...
  - [Sample scan templates](scst-scan/ivs-custom-samples.hbs.md) have been created to  to help users get started with examples of how to "bring your own scanner"
  ...
  - VMware  continues to encourage feedback on Supply Chain Security Tools - Scan 2.0 component. Email your Tanzu representative or [contact us here](https://tanzu.vmware.com/application-platform)
