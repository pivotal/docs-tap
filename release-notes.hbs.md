...
#### <a id='1-8-0-ootb-templates'></a> v1.8.0 Known issues: Out of the Box Templates

- Upgrading from TAP 1.6.3 and prior can cause deployed applications to show reconcililiation error.
- Using a deliverable generated by TAP 1.6.3 and prior will fail to update the web workload.
