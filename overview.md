...
Tanzu Application Platform is available from predefined profiles or individual packages. The profiles have been designed to allow the Tanzu Application Platform to scale across an organization's multi-cluster, multi-cloud or hybrid cloud infrastructure. 
