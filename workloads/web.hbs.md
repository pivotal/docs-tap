...
and follow [The twelve-factor app](https://12factor.net) methodology.

The `web` workload is a good match for twelve-factor and modern stateless applications,
...
The `tanzu-java-web-app` workload used in [Deploy an app on Tanzu Application Platform](../getting-started/deploy-first-app.hbs.md) in the Get started guide is a good match for the `web` workload type.
