...
This how-to guide walks service operators and application operators through setting up services for consumption by application developers. For the sake of example, you'll set up the RabbitMQ Cluster Kubernetes operator.
...
to create and manage the services themselves. For more information, see [Resource Claims](https://docs.vmware.com/en/Services-Toolkit-for-VMware-Tanzu-Application-Platform/0.7/svc-tlk/GUID-resource_claims-api_docs.html).
