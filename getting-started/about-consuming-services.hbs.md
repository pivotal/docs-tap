...
1. RabbitMQ Cluster Operator for Kubernetes. For more information, see the [RabbitMQ documentation](https://docs.vmware.com/en/VMware-RabbitMQ-for-Kubernetes/index.html).
