...
1. (Optional) Update Tanzu Application Platform to use the latest patch:
    ...
    >**Note** Tanzu Application Platform (GitOps) does not provide a separate artifact for each patch version within a minor line. For example Tanzu Application Platform 1.6.x will contain the gitops artifact with version 1.6.1 only.
