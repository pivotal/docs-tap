...
4. To bind a service to a workload, see the [--service-ref flag](../cli-plugins/apps/command-reference/commands-details/workload_create_update_apply.md#apply-service-ref).
